...
interface JSONEditorOptions {
    ace?: any; // custom version of ace editor library
    ajv?: any; // custom version of "ajv" schema validation library
    ...
    name?: string;
    schema?: JSONSchema4;
    schemaRefs?: object; // {refProp: JSONSchema4}
    search?: boolean;
    indentation?: Number;
    theme?: string;
    templates?: Object[];
    autocomplete?: Object; // could create a template for this too
...
declare class JSONEditor {
    ...
    setSchema(schema: JSONSchema4, schemaRefs?: Object);
    setText(jsonString); // must be parseable as json
    ...
    static registerMode: (mode: Object|Object[]) => void;
